...
public class Pill_add extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrAd = new ArrayAdapter<String>(Pill_add.this, android.R.layout.simple_spinner_item, arrList);
...
//                });
    ...
    private void restart_dialog() {
        Intent i = new Intent(getApplicationContext(), AlertRestart.class);
        startActivity(i);
    }
