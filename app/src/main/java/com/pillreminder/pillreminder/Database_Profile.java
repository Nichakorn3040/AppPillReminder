...
public class Database_Profile extends SQLiteOpenHelper {
	
    // Database Version
    private static final int DATABASE_VERSION = 1;
 
    // Database Name
    private static final String DATABASE_NAME = "registtertestedde";
 
    // Table Name
    private static final String TABLE_NAME = "registtertesteeddtable";

	public Database_Profile(Context context) {
